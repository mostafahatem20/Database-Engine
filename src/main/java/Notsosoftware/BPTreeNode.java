...
public abstract class BPTreeNode<T extends Comparable<T>> implements Serializable {
	 ...
	 */
	public abstract PushUp<T> insert(T key, Vector<Ref> recordReference, BPTreeInnerNode<T> parent, int ptr);
	...
	protected abstract boolean deleteByRef(Ref ref,BPTreeInnerNode<T> parent, int ptr);
	...
	public abstract boolean delete(T key, BPTreeInnerNode<T> parent, int ptr, int PageNum, int IndexInPage);

	public abstract void setRef(T key, Vector<Ref> reference);

	public abstract void setRef2(T key, Ref reference, int N);

	public abstract void setRef3(T key, Ref reference, int N);

	public abstract BPTreeNode<T> getNode(T key);
	...
	protected abstract Vector searchPos(T key);
	protected abstract BPTreeLeafNode getFirstNode();
	public abstract BPTreeNode<T> getNodeGreater(T key);
	public abstract BPTreeNode<T> getNodeGreaterE(T key);
